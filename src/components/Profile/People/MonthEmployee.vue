<template>
    <v-row class="d-block ma-0 pt-4 pb-6 px-7 deep-purple accent-4 width-100 vertical-scroll dont-show-scroll rounded-xl">
      <p class="white--text font-weight-regular text-h6 mb-4">Employee of the Month!</p>
