<template>
  <div class="flex-space-between" >
    ...
    <template v-else>
      <v-avatar
        class="pointer"
        :color="iconData.iconBackgroundColor"
        size="100"
...
export default {
  ...
  methods: {
    ...
    async selectIconAction(selected, iconInfo) {
      ...
      if (selected) {
        herehere
        const { icon: iconName, background: iconBackgroundColor, iconColor } = iconInfo
        await this.setIconData({ iconName, iconBackgroundColor, iconColor })
      }
    },
