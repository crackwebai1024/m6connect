<template>
    <v-container class="py-0 px-0">
        ...
        <div v-if="get_screen_status()" class="d-flex blue darken-1 white--text pl-3 pr-2 py-2">
            ...
            <v-spacer></v-spacer>
            <v-icon color="white" @click="hidden_full_screen(get_record_full_screen())" size="18" class="px-2" >mdi-arrow-bottom-left</v-icon>
        ...
        <div v-else class="d-flex blue darken-1 white--text pl-3 pr-2 py-2">
            ...
            <v-spacer></v-spacer>
            <v-icon color="white" @click="hidden_preview(headerDataRecord)" size="18" class="px-2" >mdi-arrow-bottom-left</v-icon>
...
export default {
    ...
    methods: {
        ...mapActions("GeneralListModule", [
            "preview_screen", "remove_record_from_active", "hidden_full_screen",
