<template>
  <v-container
    v-if="Object.keys(itapp_description).length != 0"
  ...
  >
    <v-btn
      ...
      small
      @click="showUpdateDialog(itapp_description)"
    >
    ...
    <div class="d-flex justify-space-between">
      ...
      <p class="font-weight-bold mb-1 text-caption text-right white--text">
        {{ itapp_description['general_info']['vendor_id'] }}
      </p>
    </div>
    ...
    <div class="d-flex justify-space-between">
      ...
      <p class="font-weight-bold mb-1 text-caption text-right white--text">
        {{ itapp_description['general_info']['status']['value'] }}
      </p>
    </div>
    <v-divider class="grey mb-2" />
    <div class="d-flex justify-space-between">
      ...
      <p class="font-weight-bold mb-1 text-caption text-right white--text">
        {{ itapp_description['general_info']['first_contact_group']['value'] }}
      </p>
    </div>
    <v-divider class="grey mb-2" />
    <div class="d-flex justify-space-between">
      ...
      <p class="font-weight-bold mb-1 text-caption text-right white--text">
        {{ itapp_description['general_info']['type']['value'] }}
      </p>
    </div>
    <v-divider class="grey mb-2" />
    <div class="d-flex justify-space-between">
      ...
      <p class="font-weight-bold mb-1 text-caption text-right white--text">
        {{ itapp_description['general_info']['category']['value'] }}
      </p>
    </div>
    <v-divider class="grey mb-2" />
    <div class="d-flex justify-space-between">
      ...
      <p class="font-weight-bold mb-1 text-caption text-right white--text">
        {{ itapp_description['general_info']['sub_category']['value'] }}
      </p>
    </div>
    <v-divider class="grey mb-2" />
    <div class="d-flex justify-space-between">
      ...
      <p class="font-weight-bold mb-1 text-caption text-right white--text">
        {{ itapp_description['general_info']['app_management']['value'] }}
      </p>
    </div>
    <v-divider class="grey mb-2" />
    <div class="d-flex justify-space-between">
      ...
      <p class="font-weight-bold mb-1 text-caption text-right white--text">
        {{ itapp_description['general_info']['server_hosting_model']['value'] }}
      </p>
    </div>
    ...
    <div class="d-flex justify-space-between mt-2">
      ...
      <p class="font-weight-bold mb-1 text-caption text-right white--text">
        {{ itapp_description['information_security']['facing'] == 1 ? 'Yes' : 'No' }}
      </p>
    </div>
    <v-divider class="grey mb-2" />
    <div class="d-flex justify-space-between">
      ...
      <p class="font-weight-bold mb-1 text-caption text-right white--text">
        {{ itapp_description['information_security']['phi'] == 1 ? 'Yes' : 'No' }}
      </p>
    </div>
    <v-divider class="grey mb-2" />
    <div class="d-flex justify-space-between">
      ...
      <p class="font-weight-bold mb-1 text-caption text-right white--text">
        {{ itapp_description['information_security']['pci'] == 1 ? 'Yes' : 'No' }}
      </p>
    </div>
    <v-divider class="grey mb-2" />
    <div class="d-flex justify-space-between">
      ...
      <p class="font-weight-bold mb-1 text-caption text-right white--text">
        {{ itapp_description['information_security']['ssn_foreign']['value'] }}
      </p>
    </div>
