  ...
  methods: {
    ...
    addLineItemSpending() {
      ...
      const spendingReference = db.collection('cpm_projects')
        .doc(this.projectId).collection('spendings')
    ...
    setDialogPropertiesCategoryRef(category = '') {
      ...
      this.dialogProperties.budget_category.ref = category
    },

    openUpdateSpending(spending = {}) {
      this.expandedSpending = {}
      this.spendingToShow = spending
      this.getLineItemSpending(spending)
      this.method = 'put'
      ...
      if (typeof spending.budget_category === 'object') {
        this.setDialogPropertiesCategoryRef(spending.budget_category)
      }
