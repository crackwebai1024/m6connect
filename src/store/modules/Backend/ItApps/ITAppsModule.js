    ...
    set_filter_tag({commit}, data) {
      ...
      // GET Apps
        ...
        async get_description({}, id) {
          let response = await axios.get(`${process.env.VUE_APP_HTTP}${process.env.VUE_APP_ENDPOINT}/api/itapps/get_itapp_info/${id}`);
      ...
      // Licensing
        async get_licensing({}, appId){
          let response = await axios.get(`${process.env.VUE_APP_HTTP}${process.env.VUE_APP_ENDPOINT}/api/licensing/${appId}`);          
      ...
      // Notifications
        async post_notification({}, data){
          let res = await axios.post(`${process.env.VUE_APP_HTTP}${process.env.VUE_APP_ENDPOINT}/api/notification`, data);
          return res.data;
        },
        async get_notifications({}, id){
          let res = await axios.get(`${process.env.VUE_APP_HTTP}${process.env.VUE_APP_ENDPOINT}/api/notifications/${id}`);
          return res.data;
        },
      ...
      // Contracts
        ...
        async post_contract({}, data){
          let res = await axios.post(`${process.env.VUE_APP_HTTP}${process.env.VUE_APP_ENDPOINT}/api/contract`, data);
          return res.data;
        },
      ...
      // GETS Selects
        ...
        async get_all_selects({}, data) {
          return await axios.get(`${process.env.VUE_APP_HTTP}${process.env.VUE_APP_ENDPOINT}/api/apps_settings/per_param/field`, {params:data});
        },
      // Tags
        ...
        put_tags({}, obj){
          axios.put(`${process.env.VUE_APP_HTTP}${process.env.VUE_APP_ENDPOINT}/api/some_tags`, {params : obj});
        }
  }
};
