...
const typeMap = {
    "Notifications": o([
        ...
        { json: "application_id",  js: "application_id",  typ: u(undefined, null)                 },
        { json: "status",          js: "status",          typ: u(undefined, 0)                    },
        { json: "request_type",    js: "request_type",    typ: u(undefined, 0)                    },
        ...
        { json: "post_id",         js: "post_id",         typ: u(undefined, "")                   },
        { json: "created_at",      js: "created_at",      typ: u(undefined, Date)                 },
        { json: "updated_at",      js: "updated_at",      typ: u(undefined, Date)                 },
        { json: "post",            js: "post",            typ: u(undefined, a(r("Post")))         },
        { json: "wo_assignments",  js: "wo_assignments",  typ: u(undefined, a(r("Assignments")))  },
        { json: "record",          js: "record",          typ: u(undefined, r("Record"))          },
    ], false),
    "Post": o([
        { json: "actor",           js: "actor",           typ: u(undefined, "")                   },
        { json: "foreign_id",      js: "foreign_id",      typ: u(undefined, "")                   },
        { json: "id",              js: "id",              typ: u(undefined, "")                   },
        { json: "images",          js: "images",          typ: u(undefined, a("any"))             },
        { json: "message",         js: "message",         typ: u(undefined, "")                   },
        { json: "object",          js: "object",          typ: u(undefined, "")                   },
        { json: "origin",          js: "origin",          typ: u(undefined, null)                 },
        { json: "reaction_counts", js: "reaction_counts", typ: u(undefined, r("Counts"))          },
        { json: "target",          js: "target",          typ: u(undefined, "")                   },
        { json: "time",            js: "time",            typ: u(undefined, Date)                 },
        { json: "verb",            js: "verb",            typ: u(undefined, "")                   },
    ], false),
    "Counts": o([
        { json: "comment",         js: "comment",         typ: u(undefined, 0)                    },
        { json: "like",            js: "like",            typ: u(undefined, 0)                    },
    ], false),
    "Record": o([
        { json: "id",              js: "id",              typ: u(undefined, 0)                    },
    ...
    "Assignments": o([
        { json: "id",              js: "id",              typ: u(undefined, 0)                    },
        { json: "work_id",         js: "work_id",         typ: u(undefined, 0)                    },
