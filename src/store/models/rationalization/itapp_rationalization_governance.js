// To parse this data:
//
//   const Convert = require("@/store/models/itapp_rationalization_governance");
//
...
const typeMap = {
    "RationalizationGovernance": o([
        ...
        { json: "estimated_days_to_replace", js: "estimated_days_to_replace", typ: u(undefined, "") },
        { json: "primary_customer_group",    js: "primary_customer_group",    typ: u(undefined, "") },
        { json: "responsible_manager",       js: "responsible_manager",       typ: u(undefined, "") },
        { json: "responsible_vp_dir",        js: "responsible_vp_dir",        typ: u(undefined, "") },
        { json: "created_at",                js: "created_at",                typ: u(undefined, Date) },
        { json: "updated_at",                js: "updated_at",                typ: u(undefined, Date) },
        { json: "responsible_committee",     js: "responsible_committee",     typ: u(undefined, r("ItAppSetting")) },
        { json: "responsible_division",      js: "responsible_division",      typ: u(undefined, r("ItAppSetting")) },
        { json: "first_contact_group",       js: "first_contact_group",       typ: u(undefined, r("ItAppSetting")) }
    ], false),
    "ItAppSetting": o([
        { json: "id",                        js: "id",                        typ: u(undefined, 0) },
