...
const typeMap = {
    ...
    "abc": o([
        ...
        { json: "created_at", js: "created_at", typ: u(undefined, Date) },
        { json: "updated_at", js: "updated_at", typ: u(undefined, Date) },
        { json: "status", js: "status", typ: u(undefined, r("AppManagement")) },
        { json: "first_contact_group", js: "first_contact_group", typ: u(undefined, r("AppManagement")) },
        { json: "category", js: "category", typ: u(undefined, r("AppManagement")) },
        { json: "sub_category", js: "sub_category", typ: u(undefined, r("AppManagement")) },
        { json: "type", js: "type", typ: u(undefined, r("AppManagement")) },
        { json: "app_management", js: "app_management", typ: u(null, r("AppManagement")) },
        { json: "server_hosting_model", js: "server_hosting_model", typ: u(null, r("AppManagement")) },
        { json: "capability", js: "capability", typ: u(null, r("AppManagement")) },
    ]),
    "Known": o([
        { json: "id", js: "id", typ: u(undefined, 0) },
    ...
    "GeneralInfo": o([
        ...
        { json: "created_at", js: "created_at", typ: u(undefined, Date) },
        { json: "updated_at", js: "updated_at", typ: u(undefined, Date) },
        { json: "status", js: "status", typ: u(undefined, r("AppManagement"), 0) },
        { json: "first_contact_group", js: "first_contact_group", typ: u(undefined, r("AppManagement"), 0) },
        { json: "category", js: "category", typ: u(undefined, r("AppManagement"), 0) },
        { json: "sub_category", js: "sub_category", typ: u(undefined, r("AppManagement"), 0) },
        { json: "type", js: "type", typ: u(undefined, r("AppManagement"), 0) },
        { json: "app_management", js: "app_management", typ: u(null, r("AppManagement"), 0) },
        { json: "server_hosting_model", js: "server_hosting_model", typ: u(null, r("AppManagement"), 0) },
        { json: "capability", js: "capability", typ: u(null, r("AppManagement"), 0) },
    ], false),
    "AppManagement": o([
        { json: "id", js: "id", typ: u(undefined, 0) },
        { json: "value", js: "value", typ: u(undefined, "") },
